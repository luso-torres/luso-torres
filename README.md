...
- **Description**: The project implements spatial and frequency filtering for feature extraction and image classification using Computer Vision with reduced dimensions. The model will be implemented on a pattern recognition algorithm using Convolutional Neural Networks (CNNs).
